...
FORMAT = ihex
TARGET = fmxmit
SRC = main.c overclock.c music/songdata.c music/dds.c music/player.c
DEPS=
ASRC = 
OPT = s
...
CTUNING = -ffreestanding -mcall-prologues
...
#### DEFAULT ATTIMY45 FUSES, 8MHZ internal RC OSC
#EFUSE=0xff
#HFUSE=0xdf
#LFUSE=0x62

#### ATTIMY45 V-USB, 16.5MHZ internal RC OSC
#EFUSE=0xff
#HFUSE=0xdd
#LFUSE=0xc1
